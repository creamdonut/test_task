...
if ($check){
	...
	// В задании не совсем понятно обозначены пременные, из-за чего не совсем становаится понятна сама формула расчёта. По факту задания треюуется расчитать сколько денег человек получит по вкладу от 1 до 5 лет при разных условиях. Но формула считается какую-то сумму на счёте на месяц N. Поле "Срок вклада" не применяется в формуле, на основе которой можно было бы посчитать сколько денег человек получит по истечению определенного срока, в данном случае от 1 до 5 лет. 
